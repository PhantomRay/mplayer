...
class WaterRipple extends StatefulWidget {
  ...
  const WaterRipple({Key key, this.count = 3, this.color = const Color(0xFF0080ff), this.duration = 2000}) : super(key: key);
...
class _WaterRippleState extends State<WaterRipple> with SingleTickerProviderStateMixin {
  ...
  @override
  void initState() {
    _controller = AnimationController(vsync: this, duration: Duration(milliseconds: widget.duration))..repeat();
    super.initState();
  }
